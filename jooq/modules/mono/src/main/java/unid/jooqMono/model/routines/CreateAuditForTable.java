...
public class CreateAuditForTable extends AbstractRoutine<java.lang.Void> {

    private static final long serialVersionUID = 1L;

    /**
     * The parameter <code>public.create_audit_for_table.table_name</code>.
     */
     ...
     */
    public CreateAuditForTable() {
        super("create_audit_for_table", Public.PUBLIC);
