...
public class _AuditLogAcademicMajorSubjectMapPojo implements Serializable {
    ...
    public _AuditLogAcademicMajorSubjectMapPojo() {}

    public _AuditLogAcademicMajorSubjectMapPojo(_AuditLogAcademicMajorSubjectMapPojo value) {
     ...
     * <code>public._audit_log_academic_major_subject_map.audit_seq</code>.
     */
    public _AuditLogAcademicMajorSubjectMapPojo setAuditSeq(@Nonnull Long auditSeq) {
        this.auditSeq = auditSeq;
        return this;
    }
     ...
     * <code>public._audit_log_academic_major_subject_map.audit_createdon</code>.
     */
    public _AuditLogAcademicMajorSubjectMapPojo setAuditCreatedon(@Nonnull OffsetDateTime auditCreatedon) {
        this.auditCreatedon = auditCreatedon;
        return this;
    }
     ...
     * <code>public._audit_log_academic_major_subject_map.audit_createdby</code>.
     */
    public _AuditLogAcademicMajorSubjectMapPojo setAuditCreatedby(@Nonnull String auditCreatedby) {
        this.auditCreatedby = auditCreatedby;
        return this;
    }
     ...
     * <code>public._audit_log_academic_major_subject_map.audit_operation</code>.
     */
    public _AuditLogAcademicMajorSubjectMapPojo setAuditOperation(@Nonnull String auditOperation) {
        this.auditOperation = auditOperation;
        return this;
    }
     ...
     * <code>public._audit_log_academic_major_subject_map.audit_type</code>.
     */
    public _AuditLogAcademicMajorSubjectMapPojo setAuditType(@Nonnull String auditType) {
        this.auditType = auditType;
        return this;
    }
     ...
     */
    public _AuditLogAcademicMajorSubjectMapPojo setId(@Nonnull UUID id) {
        this.id = id;
        return this;
    }
     ...
     * <code>public._audit_log_academic_major_subject_map.academic_major_id</code>.
     */
    public _AuditLogAcademicMajorSubjectMapPojo setAcademicMajorId(@Nonnull UUID academicMajorId) {
        this.academicMajorId = academicMajorId;
        return this;
    }
     ...
     * <code>public._audit_log_academic_major_subject_map.academic_subject_id</code>.
     */
    public _AuditLogAcademicMajorSubjectMapPojo setAcademicSubjectId(@Nonnull UUID academicSubjectId) {
        this.academicSubjectId = academicSubjectId;
        return this;
    }
     ...
     * <code>public._audit_log_academic_major_subject_map.created_on</code>.
     */
    public _AuditLogAcademicMajorSubjectMapPojo setCreatedOn(@Nullable OffsetDateTime createdOn) {
        this.createdOn = createdOn;
        return this;
    }
     ...
     * <code>public._audit_log_academic_major_subject_map.created_by</code>.
     */
    public _AuditLogAcademicMajorSubjectMapPojo setCreatedBy(@Nullable String createdBy) {
        this.createdBy = createdBy;
        return this;
    }
     ...
     * <code>public._audit_log_academic_major_subject_map.updated_on</code>.
     */
    public _AuditLogAcademicMajorSubjectMapPojo setUpdatedOn(@Nullable OffsetDateTime updatedOn) {
        this.updatedOn = updatedOn;
        return this;
    }
     ...
     * <code>public._audit_log_academic_major_subject_map.updated_by</code>.
     */
    public _AuditLogAcademicMajorSubjectMapPojo setUpdatedBy(@Nullable String updatedBy) {
        this.updatedBy = updatedBy;
        return this;
    }
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("_AuditLogAcademicMajorSubjectMapPojo (");
