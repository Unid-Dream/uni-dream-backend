...
public class EventPojo implements Serializable {
    ...
    public EventPojo(EventPojo value) {
        this.id = value.id;
     ...
     */
    public EventPojo setId(@Nonnull UUID id) {
        this.id = id;
        return this;
    }
     ...
     */
    public EventPojo setTitleI18nId(@Nullable UUID titleI18nId) {
        this.titleI18nId = titleI18nId;
        return this;
    }
     ...
     */
    public EventPojo setDescriptionI18nId(@Nullable UUID descriptionI18nId) {
        this.descriptionI18nId = descriptionI18nId;
        return this;
    }
     ...
     */
    public EventPojo setEventType(@Nonnull EventTypeEnum eventType) {
        this.eventType = eventType;
        return this;
    }
     ...
     */
    public EventPojo setStartDate(@Nullable LocalDate startDate) {
        this.startDate = startDate;
        return this;
    }
     ...
     */
    public EventPojo setEndDate(@Nullable LocalDate endDate) {
        this.endDate = endDate;
        return this;
    }
     ...
     */
    public EventPojo setStartTime(@Nullable LocalTime startTime) {
        this.startTime = startTime;
        return this;
    }
     ...
     */
    public EventPojo setEndTime(@Nullable LocalTime endTime) {
        this.endTime = endTime;
        return this;
    }
     ...
     */
    public EventPojo setMaxNumberOfStudent(@Nullable BigDecimal maxNumberOfStudent) {
        this.maxNumberOfStudent = maxNumberOfStudent;
        return this;
    }
     ...
     */
    public EventPojo setFee(@Nullable BigDecimal fee) {
        this.fee = fee;
        return this;
    }
     ...
     */
    public EventPojo setPosterImage(@Nullable String posterImage) {
        this.posterImage = posterImage;
        return this;
    }
     ...
     */
    public EventPojo setPrice(@Nullable BigDecimal price) {
        this.price = price;
        return this;
    }
     ...
     */
    public EventPojo setCreatedOn(@Nullable OffsetDateTime createdOn) {
        this.createdOn = createdOn;
        return this;
    }
     ...
     */
    public EventPojo setCreatedBy(@Nullable String createdBy) {
        this.createdBy = createdBy;
        return this;
    }
     ...
     */
    public EventPojo setUpdatedOn(@Nullable OffsetDateTime updatedOn) {
        this.updatedOn = updatedOn;
        return this;
    }
     ...
     */
    public EventPojo setUpdatedBy(@Nullable String updatedBy) {
        this.updatedBy = updatedBy;
        return this;
    }
