...
public class LanguagePojo implements Serializable {
    ...
    public LanguagePojo(LanguagePojo value) {
        this.id = value.id;
     ...
     */
    public LanguagePojo setId(@Nonnull UUID id) {
        this.id = id;
        return this;
    }
     ...
     */
    public LanguagePojo setDescriptionI18nId(@Nullable UUID descriptionI18nId) {
        this.descriptionI18nId = descriptionI18nId;
        return this;
    }
     ...
     */
    public LanguagePojo setTagId(@Nullable UUID tagId) {
        this.tagId = tagId;
        return this;
    }
     ...
     */
    public LanguagePojo setCreatedOn(@Nullable OffsetDateTime createdOn) {
        this.createdOn = createdOn;
        return this;
    }
     ...
     */
    public LanguagePojo setCreatedBy(@Nullable String createdBy) {
        this.createdBy = createdBy;
        return this;
    }
     ...
     */
    public LanguagePojo setUpdatedOn(@Nullable OffsetDateTime updatedOn) {
        this.updatedOn = updatedOn;
        return this;
    }
     ...
     */
    public LanguagePojo setUpdatedBy(@Nullable String updatedBy) {
        this.updatedBy = updatedBy;
        return this;
    }
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("LanguagePojo (");
