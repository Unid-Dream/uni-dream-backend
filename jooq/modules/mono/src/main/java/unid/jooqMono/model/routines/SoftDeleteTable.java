...
public class SoftDeleteTable extends AbstractRoutine<java.lang.Void> {

    private static final long serialVersionUID = 1L;

    /**
     * The parameter <code>public.soft_delete_table.table_name</code>.
     */
     ...
     */
    public SoftDeleteTable() {
        super("soft_delete_table", Public.PUBLIC);
